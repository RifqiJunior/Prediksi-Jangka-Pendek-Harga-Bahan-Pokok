# views.py file eksel sudah di dalam program
...
def calculate_wema(request):
    if request.method == 'POST':
        ...
        # Hapus semua hasil sebelumnya sebelum melakukan perhitungan baru
        ...
        for i, kom in enumerate(komoditas, 1):
            ...
            mape_percentage = "{:.2f}".format(mape * 100)  # Format menjadi 2 angka di belakang koma
